[
  ...
  {
    name = "aikyo-package-manager";
    url = "https://github.com/akazdayo/aikyo-package-manager";
    stars = 1;
    language = "Rust";
    pushedAt = "2025-09-13T09:19:08Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "expression";
    url = "https://github.com/akazdayo/expression";
    stars = 1;
    language = "Gleam";
    pushedAt = "2026-03-07T00:39:16Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "kawaii-nostr-web";
    url = "https://github.com/akazdayo/kawaii-nostr-web";
    stars = 1;
    language = "TypeScript";
    pushedAt = "2025-12-18T17:38:30Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  {
    name = "10seconds";
    url = "https://github.com/akazdayo/10seconds";
    stars = 0;
    language = "JavaScript";
    pushedAt = "2021-10-07T09:37:13Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "20254q_exp_work";
    url = "https://github.com/akazdayo/20254q_exp_work";
    stars = 0;
    language = null;
    pushedAt = "2026-02-03T02:10:44Z";
    topics = [ ];
    archived = false;
    fork = true;
  }
  {
    name = "2026-01-31";
    url = "https://github.com/akazdayo/2026-01-31";
    stars = 0;
    language = "TypeScript";
    pushedAt = "2026-01-31T06:07:04Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  {
    name = "Bingo";
    url = "https://github.com/akazdayo/Bingo";
    stars = 0;
    language = "HTML";
    pushedAt = "2023-09-14T05:28:06Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "ColorfulSE";
    url = "https://github.com/akazdayo/ColorfulSE";
    stars = 0;
    language = null;
    pushedAt = "2024-03-03T15:32:23Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  {
    name = "MRTalk";
    url = "https://github.com/akazdayo/MRTalk";
    stars = 0;
    language = "TypeScript";
    pushedAt = "2025-06-07T08:14:49Z";
    topics = [ ];
    archived = false;
    fork = true;
  }
  {
    name = "MRTalk-GPT-SoVITS";
    url = "https://github.com/akazdayo/MRTalk-GPT-SoVITS";
    stars = 0;
    language = "Python";
    pushedAt = "2025-05-20T06:22:14Z";
    topics = [ ];
    archived = false;
    fork = true;
  }
  {
    name = "MathGame";
    url = "https://github.com/akazdayo/MathGame";
    stars = 0;
    language = "Python";
    pushedAt = "2024-04-25T12:53:18Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  }
  {
    ...
    url = "https://github.com/akazdayo/MondaminDiceProgram";
    stars = 0;
    language = null;
    pushedAt = "2024-05-17T15:26:32Z";
    topics = [ ];
    archived = false;
    fork = true;
  }
  ...
  }
  {
    ...
    url = "https://github.com/akazdayo/PythonOverlayLib";
    stars = 0;
    language = "Python";
  ...
  }
  {
    ...
    url = "https://github.com/akazdayo/VirtualCharacterControlProtocol";
    stars = 0;
    language = null;
    pushedAt = "2025-07-25T12:04:06Z";
    topics = [ ];
    archived = false;
    fork = true;
  }
  {
    name = "WiVRn";
    url = "https://github.com/akazdayo/WiVRn";
    stars = 0;
    language = "C++";
    pushedAt = "2025-12-22T09:34:17Z";
    topics = [ ];
    archived = false;
    fork = true;
  }
  {
    name = "YukkuriMovieMaker4PluginSamples";
    url = "https://github.com/akazdayo/YukkuriMovieMaker4PluginSamples";
    stars = 0;
    language = null;
    pushedAt = "2023-10-10T11:45:34Z";
    topics = [ ];
    archived = false;
    fork = true;
  }
  ...
  {
    name = "aikyo-aituber";
    url = "https://github.com/akazdayo/aikyo-aituber";
    stars = 0;
    language = "TypeScript";
    pushedAt = "2026-05-16T15:22:24Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "aikyo-aituberkit-bridge";
    url = "https://github.com/akazdayo/aikyo-aituberkit-bridge";
    stars = 0;
    language = "TypeScript";
    pushedAt = "2026-06-08T19:55:12Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "aikyo-basic-template";
    url = "https://github.com/akazdayo/aikyo-basic-template";
    stars = 0;
    language = "TypeScript";
    pushedAt = "2025-08-29T12:14:20Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "aikyo-blank-template";
  ...
  {
    name = "aikyo-discord";
    url = "https://github.com/akazdayo/aikyo-discord";
    stars = 0;
    language = "TypeScript";
    pushedAt = "2026-05-29T13:49:37Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  }
  {
    ...
    stars = 0;
    language = null;
    pushedAt = "2026-06-17T05:33:55Z";
    topics = [ ];
    archived = false;
    fork = true;
  }
  {
    name = "aituber-kit-aikyo-demo";
    url = "https://github.com/akazdayo/aituber-kit-aikyo-demo";
    stars = 0;
    language = "TypeScript";
    pushedAt = "2025-10-02T04:34:07Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  {
    name = "akazdayo.github.io";
    url = "https://github.com/akazdayo/akazdayo.github.io";
    stars = 0;
    language = null;
    pushedAt = "2025-11-04T16:00:25Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "anime-checker";
    url = "https://github.com/akazdayo/anime-checker";
    stars = 0;
    language = "HTML";
    pushedAt = "2023-09-11T07:14:37Z";
    topics = [ ];
    archived = false;
    fork = true;
  }
  ...
  {
    name = "auto-yukkuri-web";
    url = "https://github.com/akazdayo/auto-yukkuri-web";
    stars = 0;
    language = "JavaScript";
    pushedAt = "2025-11-16T11:33:24Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  {
    name = "dev-templates";
    url = "https://github.com/akazdayo/dev-templates";
    stars = 0;
    language = null;
    pushedAt = "2026-02-27T14:45:57Z";
    topics = [ ];
    archived = false;
    fork = true;
  }
  ...
  {
    name = "dotfiles";
    url = "https://github.com/akazdayo/dotfiles";
    stars = 0;
    language = null;
    pushedAt = "2025-04-02T12:13:52Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "easy-live-platform";
    url = "https://github.com/akazdayo/easy-live-platform";
    stars = 0;
    language = null;
    pushedAt = "2026-06-09T00:12:23Z";
    topics = [ ];
    archived = false;
    fork = true;
  }
  ...
  {
    name = "enhanced-tetris";
    url = "https://github.com/akazdayo/enhanced-tetris";
    stars = 0;
    language = "JavaScript";
    pushedAt = "2025-06-21T15:43:54Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "ethereum-counter-app";
    url = "https://github.com/akazdayo/ethereum-counter-app";
    stars = 0;
    language = "TypeScript";
    pushedAt = "2026-01-12T11:38:46Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "fbx2video";
    url = "https://github.com/akazdayo/fbx2video";
    stars = 0;
    language = "Python";
    pushedAt = "2025-08-17T09:50:31Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "first-vuetify-app";
  ...
  {
    name = "hatena-abstract";
    url = "https://github.com/akazdayo/hatena-abstract";
    stars = 0;
    language = "TypeScript";
    pushedAt = "2025-07-03T08:22:15Z";
    topics = [ ];
    archived = true;
    fork = false;
  }
  {
    name = "homebrew-tap";
    url = "https://github.com/akazdayo/homebrew-tap";
    stars = 0;
    language = "Ruby";
    pushedAt = "2025-09-13T09:22:59Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  {
    name = "img2asciivideo";
    url = "https://github.com/akazdayo/img2asciivideo";
    stars = 0;
    language = "Rust";
    pushedAt = "2026-05-08T11:15:59Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  {
    name = "kirara";
    url = "https://github.com/akazdayo/kirara";
    stars = 0;
    language = "TypeScript";
  ...
  }
  {
    ...
    stars = 0;
    language = "Python";
    pushedAt = "2024-06-16T03:45:54Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "llm-speaker-test";
    url = "https://github.com/akazdayo/llm-speaker-test";
    stars = 0;
    language = "TypeScript";
    pushedAt = "2025-08-30T12:38:58Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  {
    name = "markdown-parser-nix";
    url = "https://github.com/akazdayo/markdown-parser-nix";
    stars = 0;
    language = "Nix";
    pushedAt = "2026-02-21T06:04:54Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  {
    name = "meishi";
    url = "https://github.com/akazdayo/meishi";
    stars = 0;
    language = "Nix";
    pushedAt = "2026-03-26T12:19:45Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  {
    name = "mojo";
    url = "https://github.com/akazdayo/mojo";
    stars = 0;
    language = null;
    pushedAt = "2023-09-07T20:51:59Z";
    topics = [ ];
    archived = false;
    fork = true;
  }
  ...
  {
    name = "nostr-grass";
    url = "https://github.com/akazdayo/nostr-grass";
    stars = 0;
    language = "HTML";
    pushedAt = "2025-12-18T17:27:21Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "nostr-humanize-bot";
    url = "https://github.com/akazdayo/nostr-humanize-bot";
    stars = 0;
    language = "Python";
    pushedAt = "2026-01-08T12:04:02Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "nostr-kind1-csv";
  ...
  {
    name = "nostr-mcp";
    url = "https://github.com/akazdayo/nostr-mcp";
    stars = 0;
    language = null;
  ...
  {
    name = "nostr-nip05-template";
    url = "https://github.com/akazdayo/nostr-nip05-template";
    stars = 0;
    language = null;
    pushedAt = "2025-11-04T16:03:42Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "nostr-profile-embed";
  ...
  }
  {
    ...
    url = "https://github.com/akazdayo/nostr-summary-bot";
    stars = 0;
    language = "TypeScript";
    pushedAt = "2025-11-17T14:57:26Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "nostr-workers-relay";
  ...
  {
    name = "nuitka-actions-test";
    url = "https://github.com/akazdayo/nuitka-actions-test";
    stars = 0;
    language = null;
    pushedAt = "2023-12-21T03:59:15Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    ...
    stars = 0;
    language = null;
    pushedAt = "2026-05-28T16:00:14Z";
    topics = [ ];
    archived = false;
    fork = true;
  }
  {
    name = "openclaw-do-nix";
    url = "https://github.com/akazdayo/openclaw-do-nix";
    stars = 0;
    language = "Nix";
    pushedAt = "2026-09-03T07:56:12Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    ...
    url = "https://github.com/akazdayo/pdf-highlighter";
    stars = 0;
    language = "Python";
    pushedAt = "2025-04-07T15:09:19Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "physiquest-share";
  ...
  {
    name = "physiquest_animation_generator";
  ...
  {
    name = "pixelart-api";
    url = "https://github.com/akazdayo/pixelart-api";
    stars = 0;
    language = "Python";
    pushedAt = "2025-04-26T15:01:03Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  {
    name = "pixelart-cam";
    url = "https://github.com/akazdayo/pixelart-cam";
    stars = 0;
    language = "Python";
    pushedAt = "2025-04-23T07:43:21Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "pixelart-realtime-tauri";
    url = "https://github.com/akazdayo/pixelart-realtime-tauri";
    stars = 0;
    language = "TypeScript";
    pushedAt = "2026-05-28T17:21:53Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "polka";
    url = "https://github.com/akazdayo/polka";
    stars = 0;
    language = null;
    pushedAt = "2026-01-07T07:26:49Z";
    topics = [ ];
    archived = false;
    fork = true;
  }
  ...
  {
    name = "rebocap-linux";
    url = "https://github.com/akazdayo/rebocap-linux";
    stars = 0;
    language = "Shell";
    pushedAt = "2026-08-31T08:36:11Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    ...
    stars = 0;
    language = "TypeScript";
    pushedAt = "2026-06-09T00:14:39Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "rem-zombie-twitter";
    url = "https://github.com/akazdayo/rem-zombie-twitter";
    stars = 0;
    language = "JavaScript";
  ...
  {
    name = "resource";
    url = "https://github.com/akazdayo/resource";
    stars = 0;
    language = "Python";
    pushedAt = "2025-06-02T10:43:56Z";
    topics = [ ];
    archived = false;
    fork = true;
  }
  {
    name = "save-the-discord";
    url = "https://github.com/akazdayo/save-the-discord";
    stars = 0;
    language = "Python";
    pushedAt = "2024-10-24T04:59:54Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  {
    name = "smart-event";
    url = "https://github.com/akazdayo/smart-event";
    stars = 0;
    language = "TypeScript";
    pushedAt = "2025-03-14T15:58:27Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  {
    name = "spinner_omiikuji";
    url = "https://github.com/akazdayo/spinner_omiikuji";
    stars = 0;
    language = "Python";
    pushedAt = "2023-02-07T08:51:37Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "stellar-appview";
    url = "https://github.com/akazdayo/stellar-appview";
    stars = 0;
    language = null;
    pushedAt = "2024-12-21T01:53:32Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  }
  {
    ...
    stars = 0;
    language = "HTML";
    pushedAt = "2023-07-12T05:25:31Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "tds-farm-theory-value";
    url = "https://github.com/akazdayo/tds-farm-theory-value";
    stars = 0;
    language = "Python";
    pushedAt = "2023-07-29T14:07:31Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "tor-middle-relay.nix";
    url = "https://github.com/akazdayo/tor-middle-relay.nix";
    stars = 0;
    language = "Nix";
    pushedAt = "2026-09-03T07:46:29Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  {
    name = "uzu-lab_site";
    url = "https://github.com/akazdayo/uzu-lab_site";
    stars = 0;
    language = "HTML";
    pushedAt = "2023-10-07T04:19:38Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    name = "voicechanger";
    url = "https://github.com/akazdayo/voicechanger";
    stars = 0;
    language = null;
    pushedAt = "2024-07-11T01:14:50Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  {
    ...
    url = "https://github.com/akazdayo/vrchat-log-watcher";
    stars = 0;
    language = "Rust";
    pushedAt = "2025-11-18T15:34:57Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  {
    name = "webcam-tracking";
    url = "https://github.com/akazdayo/webcam-tracking";
    stars = 0;
    language = null;
    pushedAt = "2024-03-14T08:31:26Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  {
    name = "wordwolf-discord";
    url = "https://github.com/akazdayo/wordwolf-discord";
    stars = 0;
    language = null;
    pushedAt = "2024-08-10T06:35:51Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
  ...
  }
  {
    ...
    url = "https://github.com/akazdayo/youtube-archive";
    stars = 0;
    language = null;
    pushedAt = "2022-12-06T13:45:58Z";
    topics = [ ];
    archived = false;
    fork = true;
  }
