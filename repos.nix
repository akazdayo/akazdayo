[
  ...
  {
    name = "rebocap-nix";
    url = "https://github.com/akazdayo/rebocap-nix";
    stars = 0;
    language = "Shell";
    pushedAt = "2026-08-30T04:29:08Z";
    topics = [ ];
    archived = false;
    fork = false;
  }
